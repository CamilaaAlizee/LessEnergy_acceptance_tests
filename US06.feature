...
When [selecciona] la opción ["Políticas de privacidad"] 
Then el sistema debe [mostrar] el [documento actualizado] con las [políticas vigentes] 
...
TA02
Given que el [usuario] revisa la [configuración de privacidad] 
