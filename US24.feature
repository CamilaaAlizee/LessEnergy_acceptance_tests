...
TA01
Given que el <usuario> tiene acceso a la <configuracion de la aplicación>
...
TA02
Given que el <usuario> ha cambiado el <tema de la aplicacion>
And el <sistema> registre esta <configuracion>
When el <usuario> cierra y abre la aplicación
Then la <aplicacion> mantendrá el <tema previamente elegido>
